# Generated by Django 2.2.5 on 2020-02-09 10:05
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('orders', '0028_auto_20200209_1900'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=phonenumber_field.modelfields.PhoneNumberField(default=1, max_length=15, region=None, verbose_name='電話番号(お届け先)'),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='order',
            name='postal_code_orderer',
            field=models.CharField(default=1, max_length=7, verbose_name='郵便番号(お届け先)'),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='order',
            name='prefecture_orderer',
            field=core.models.JPPrefectureField(default=1, max_length=2, verbose_name='都道府県(お届け先)'),
            preserve_default=False,
        ),
    ]
